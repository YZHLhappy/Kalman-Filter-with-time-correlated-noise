function [u_out,l_obs_FGn,R] = Observation_with_FGn_withQ(n_simu,v,A,phi,sigma,H,n,N,force,wn)
% This function is used to generate observations with Fractional Gaussian noise(with system noise) 
